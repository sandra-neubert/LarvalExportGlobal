...
% Paths *******************************************
%local
boats.param.path.wrkdir = ['YOUR_PATH\Analysis\BOATS\sneubert-boats_v1\'];
boats.param.path.outdir = ['YOUR_PATH\Analysis\BOATS\sneubert-boats_v1\output\'];
...
% Names and Switches ******************************
 ...
 boats.param.main.sim_name     = 'Boats_reg0_mvmt1_d250';           % Simulation name (_nuclear for nuclear war simulations); m250 (monthly 250 years; d250: daily for 250 years); reg0C (cheapest waldron), reg0T (Top 30 Waldron)
